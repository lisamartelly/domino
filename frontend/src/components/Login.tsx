...
function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Form doesn't do anything as requested
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-cream-50 rounded-2xl p-8 border-2 border-charcoal-200 shadow-2xl">
          ...
          <div className="mt-6 mb-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-cream-50 text-charcoal-500">
                  Or continue with
                </span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              type="button"
              className="flex items-center justify-center px-4 py-3 bg-white border-2 border-charcoal-200 rounded-lg text-charcoal-700 hover:bg-accent2-50 hover:border-accent2-300 transition-colors"
            >
